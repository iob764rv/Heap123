...
# Modified for Exercise 7, with write_sin_02
...
for n in range(0, N):
    ...
    y0 = y0 * cos(2*pi*f1)       	# amplitude with cos
    
    byte_string = pack('h', int(y0))
